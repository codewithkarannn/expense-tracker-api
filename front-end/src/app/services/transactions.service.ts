...
export class TransactionsService {
  ...
  addTransactionCategory(
    category: AddTransactionCategoryMasterDTO,
  ): Observable<ApiResponse<TransactionCategory>> {
    return this.httpClient
      .post<
        ApiResponse<TransactionCategory>
      >(`${this.baseUrl}/Transaction/addtransactioncategory`, category)
      .pipe(
        catchError((error) => {
  ...
  addTransactionPayementMode(
    paymentMode: TransactionPaymentMode,
  ): Observable<ApiResponse<TransactionPaymentMode>> {
    return this.httpClient
      .post<
        ApiResponse<TransactionPaymentMode>
      >(`${this.baseUrl}/Transaction/addtransactionpaymentmode`, paymentMode)
      .pipe(
        catchError((error) => {
          console.error('Error fetching transaction types:', error);
          throw error; // Or handle it differently
  ...
  addTransactionType(
    transactionType: AddTransactionTypeMasterDTO,
  ): Observable<ApiResponse<TransactionType>> {
    return this.httpClient
      .post<
        ApiResponse<TransactionType>
      >(`${this.baseUrl}/Transaction/addtransactiontype`, transactionType)
      .pipe(
        catchError((error) => {
          console.error('Error fetching transaction types:', error);
          throw error; // Or handle it differently
  ...
  addTransaction(
    ...
    return this.httpClient
      .post<
        ApiResponse<Transaction>
      >(`${this.baseUrl}/Transaction/addtransaction`, transaction)
